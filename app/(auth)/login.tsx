...
const styles = StyleSheet.create({
  ...
  header: { position: 'absolute', top: 60, left: 20, zIndex: 1 },
  backButton: { flexDirection: 'row', alignItems: 'center' },
  backButtonText: { color: 'white', fontSize: 16, marginLeft: 8 },
  content: { flex: 1, justifyContent: 'center', alignItems: 'center' },
  brandingSection: { alignItems: 'center', marginBottom: 40 },
  logoContainer: { marginBottom: 16 },
  logoImage: { width: 80, height: 80 },
  appName: { fontSize: 24, fontWeight: 'bold', color: '#FFFFFF', marginBottom: 8, letterSpacing: 1 },
  welcomeText: { fontSize: 16, color: '#FFFFFF', opacity: 0.8 },
  inputSection: { width: '100%', maxWidth: 400 },
  inputContainer: { marginBottom: 20 },
  inputLabel: { fontSize: 16, color: '#FFFFFF', marginBottom: 8, fontWeight: '500' },
  inputWrapper: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  errorContainer: { backgroundColor: '#EF4444', borderRadius: 8, padding: 12, marginBottom: 16 },
  errorText: { color: '#FFFFFF', fontSize: 14, textAlign: 'center' },
  loginButtonDisabled: { opacity: 0.6 },
  buttonSection: { width: '100%', maxWidth: 400, gap: 16 },
  loginButton: { backgroundColor: '#FFFFFF', borderRadius: 12, paddingVertical: 16, alignItems: 'center' },
  loginButtonText: { color: '#000000', fontSize: 16, fontWeight: 'bold' },
  separator: { flexDirection: 'row', alignItems: 'center', marginVertical: 8 },
  separatorLine: { flex: 1, height: 1, backgroundColor: '#374151' },
  separatorText: { color: '#FFFFFF', marginHorizontal: 16, fontSize: 14 },
  createAccountButton: {
